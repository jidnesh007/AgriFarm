              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="relative group form-field">
                  ...
                  <input
                    ...
                    maxLength="10"
                    pattern="\d{10}"
                    className="w-full bg-transparent border-b-2 border-white/10 focus:border-emerald-400 text-white text-sm pl-7 pb-3 pt-1 outline-none transition-all duration-300 placeholder-white"

              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="relative group form-field">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-transparent border-b border-white/30 focus:border-emerald-400 text-white text-sm pl-7 pb-3 outline-none transition-all placeholder-white/40"
